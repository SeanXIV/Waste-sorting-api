...
public class PublicDataController {
    ...
    public ResponseEntity<String> initData() {
        ...
        List<WasteCategory> savedCategories = wasteCategoryRepository.saveAll(Arrays.asList(
            plastic, paper, glass, metal, organic, electronic, hazardous
        ));
        ...
        metalGuideline.setWasteCategory(metal);
        ...
        organicGuideline.setWasteCategory(organic);
        ...
        electronicGuideline.setWasteCategory(electronic);
        ...
        hazardousGuideline.setWasteCategory(hazardous);
        ...
        plasticTip1.setWasteCategory(plastic);
        ...
        plasticTip2.setWasteCategory(plastic);
        ...
        paperTip1.setWasteCategory(paper);
        ...
        paperTip2.setWasteCategory(paper);
        ...
        glassTip1.setWasteCategory(glass);
        ...
        glassTip2.setWasteCategory(glass);
        ...
        metalTip1.setWasteCategory(metal);
        ...
        metalTip2.setWasteCategory(metal);
        ...
        organicTip1.setWasteCategory(organic);
        ...
        organicTip2.setWasteCategory(organic);
        ...
        electronicTip1.setWasteCategory(electronic);
        ...
        electronicTip2.setWasteCategory(electronic);
        ...
        hazardousTip1.setWasteCategory(hazardous);
        ...
        hazardousTip2.setWasteCategory(hazardous);
